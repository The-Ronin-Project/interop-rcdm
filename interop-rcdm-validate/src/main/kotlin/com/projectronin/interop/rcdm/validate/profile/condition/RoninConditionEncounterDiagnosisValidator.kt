...
/**
 * Defines the validator for the [Ronin Condition Encounter Diagnosis](https://supreme-garbanzo-99254d0f.pages.github.io/ig/Ronin-Implementation-Guide-Home-List-Profiles-Ronin-Condition-Encounter-Diagnosis.html)
 * profile.
 */
@Component
class RoninConditionEncounterDiagnosisValidator : BaseRoninConditionProfileValidator() {
