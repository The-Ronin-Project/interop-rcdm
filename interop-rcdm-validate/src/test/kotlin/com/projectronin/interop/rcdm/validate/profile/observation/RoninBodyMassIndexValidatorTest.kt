    ...
    fun `validate fails for invalid value type`() {
        val bodyMassIndex =
            Observation(
                ...
                meta =
                    Meta(
                        profile = listOf(RoninProfile.OBSERVATION_BODY_MASS_INDEX.canonical),
                        source = Uri("source"),
                    ),
        ...
        assertEquals(
            "ERROR RONIN_INV_DYN_VAL: http://projectronin.io/fhir/StructureDefinition/ronin-observationBodyMassIndex profile restricts value to one of: Quantity @ Observation.value",
