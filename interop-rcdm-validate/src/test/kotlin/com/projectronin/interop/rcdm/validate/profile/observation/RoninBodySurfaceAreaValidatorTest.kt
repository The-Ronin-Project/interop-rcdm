...
class RoninBodySurfaceAreaValidatorTest {
    ...
    fun `validate fails for invalid value type`() {
        ...
        assertEquals(
            "ERROR RONIN_INV_DYN_VAL: http://projectronin.io/fhir/StructureDefinition/ronin-observationBodySurfaceArea profile restricts value to one of: Quantity @ Observation.value",
