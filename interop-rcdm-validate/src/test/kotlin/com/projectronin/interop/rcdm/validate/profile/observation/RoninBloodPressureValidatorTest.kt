...
class RoninBloodPressureValidatorTest {
    ...
    private val systolicCodeableConcept =
        CodeableConcept(
            coding = listOf(systolicCoding),
            text = "Systolic".asFHIR(),
        )
    private val sourceSystolicCodeExtension =
        Extension(
    ...
    private val diastolicCodeableConcept =
        CodeableConcept(
            coding = listOf(diastolicCoding),
            text = "Diastolic".asFHIR(),
        )
    private val sourceDiastolicCodeExtension =
        Extension(
            url = RoninExtension.TENANT_SOURCE_OBSERVATION_COMPONENT_CODE.uri,
            value =
                DynamicValue(
