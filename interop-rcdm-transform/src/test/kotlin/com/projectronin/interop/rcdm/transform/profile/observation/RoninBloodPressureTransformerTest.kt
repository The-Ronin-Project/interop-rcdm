...
class RoninBloodPressureTransformerTest {
    private val bloodPressureCode = Code("85354-9")
    private val bloodPressureCodingList =
        listOf(
            Coding(
    ...
    private val bloodPressureConcept =
        CodeableConcept(
    ...
    private val registryClient =
        mockk<NormalizationRegistryClient> {
            ...
            } returns ValueSetList(bloodPressureCodingList, mockk())
        }

    private val transformer = RoninBloodPressureTransformer(registryClient)
    ...
    fun `returns correct profile`() {
        assertEquals(RoninProfile.OBSERVATION_BLOOD_PRESSURE, transformer.profile)
    }
